...
1. **Giai đoạn 0: Chuẩn bị & Bản sắc Sinh viên FPT (Kỳ 0)**
   - Rèn luyện tập trung [[otp101-orientation-and-training]], thể chất Vovinam [[vov114-vovinam-1]] hoặc cờ vua [[cov111-chess-1]], và học một loại nhạc cụ truyền thống dân tộc tại [[semester-0]].

2. **Giai đoạn 1: Nền tảng Khoa học Máy tính & Cơ sở Lập trình (Kỳ 1 – 3)**
...
3. **Giai đoạn 2: Kỹ nghệ Phần mềm & Dự án Nòng cốt (Kỳ 4 – 5)**
   ...
   - Thực chiến dự án nhóm chuyên sâu tại [[semester-5]] qua [[swp391-software-development-project]], kết hợp kiểm thử [[swt301-software-testing]], UI/UX [[wdu203c-ui-ux-design]] và các môn chuyên ngành tự chọn (React [[fer202-front-end-web-development]], .NET [[prn212-cross-platform-programming-net]], Spring Boot [[hsf302-spring-framework]]).

4. **Giai đoạn 3: Đào tạo Thực tế Doanh nghiệp (Kỳ 6)**
   - Sinh viên làm việc thực tế tại các doanh nghiệp công nghệ trong [[semester-6]] với [[ojt202-on-the-job-training]].

5. **Giai đoạn 4: Kiến trúc Hệ thống & Chuyên sâu (Kỳ 7 – 8)**
   - Thiết kế kiến trúc cao cấp tại [[semester-7]] với [[swd392-software-architecture-and-design]] và các gói chuyên ngành tự chọn (NodeJS [[sdn302-server-side-development-nodejs]], Machine Learning [[ail304m-machine-learning]], Mobile [[mma301-multiplatform-mobile-app-development]]).
   - Phát triển ứng dụng di động đa nền tảng tại [[semester-8]] qua [[prm393-mobile-programming]] và lý luận chính trị [[mln111-marxist-leninist-philosophy]].

6. **Giai đoạn 5: Đồ án Tốt nghiệp & Hoàn thành Chương trình (Kỳ 9)**
   - Hiện thực hóa sản phẩm phần mềm quy mô lớn tại [[semester-9]] qua đồ án tốt nghiệp [[sep490-se-capstone-project]] hoặc khóa luận [[set490-se-graduation-thesis]], [[exe402-startup-graduation-project]].
